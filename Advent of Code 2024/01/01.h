...
void day01part1(std::string_view fileName)
{
	std::cout << "Distance between lists: " << getListsDistance( fileName ) << std::endl;
}

void day01part2(std::string_view fileName)
{
	std::cout << "Lists similarity score: " << getListsSimilarityScore( fileName ) << std::endl;
}
